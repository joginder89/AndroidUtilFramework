...
public class MainActivity extends AppCompatActivity
    ...
    private void initLayouts() {
        ...
        findViewById(R.id.bSelectAndCropImage).setOnClickListener(this);
        findViewById(R.id.bColorPicker).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bSelectImage:
                ...
                break;
            case R.id.bSelectAndCropImage:
                startActivity(new Intent(MainActivity.this, SelectAndCropImage.class));
                break;
