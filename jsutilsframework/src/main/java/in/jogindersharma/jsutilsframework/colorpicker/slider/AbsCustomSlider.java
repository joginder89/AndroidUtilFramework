package in.jogindersharma.jsutilsframework.colorpicker.slider;
...
public abstract class AbsCustomSlider extends View {
	...
	protected void updateBar() {
		handleRadius = getDimension(R.dimen.colorpicker_default_slider_handler_radius);
		barHeight = getDimension(R.dimen.colorpicker_default_slider_bar_height);
